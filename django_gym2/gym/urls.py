...
urlpatterns = [
    ...
    path('instructor_detail/<int:instructor_pk>', views.show_instructor, name='instructor_detail')
    # path('/instructor_detail/<int:instructor_id>/', views.instructor, name='instructor_detail')
]
...
class Member(models.Model):
    ...
    #dob = models.CharField(max_length=255) # for ease, leave this as a string for now, though some sort of date time would be better
    ...
    #attendance_level = models.IntegerField() # later, this will be based on their sign-ups for sessions
